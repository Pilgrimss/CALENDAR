...
QT_MOC_LITERAL(5, 36, 10), // "deleteItem"
QT_MOC_LITERAL(6, 47, 21), // "on_buttonBox_accepted"
QT_MOC_LITERAL(7, 69, 21) // "on_buttonBox_rejected"

    },
    "noteDialog\0pass\0\0passDetail\0myEvent\0"
    "deleteItem\0on_buttonBox_accepted\0"
...
void noteDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (noteDialog::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&noteDialog::deleteItem)) {
                *result = 2;
                return;
            }
        }
